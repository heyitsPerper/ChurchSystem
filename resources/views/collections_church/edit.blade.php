...
@section('title','Update Church Collection')
@section('content') 
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <i class="fas fa-table me-1"></i>
            Update Church Collection
        ...
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{url('church_collections/'.$data->id)}}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" value="{{$data->second_collection}}" name="second_collection" class="form-control" required>
                        </td>
                    <tr>  
                        <td colspan="2">
